...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("BIGFM/assets/font2.ttf", 30)
        font = ImageFont.truetype("BIGFM/assets/font.ttf", 30)
        title_font = ImageFont.truetype("BIGFM/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("BIGFM/assets/play_icons.png")
